...
//            String callbackData = BinaryUtil.toBase64String(JSONUtil.parse(callback).toString().getBytes("utf-8"));
            ...
            LogUtils.getExceptionLogger().error("签名生成失败", e);
        }
        return result;
    }
...
//            filename = request.getPart("filename").getSubmittedFileName();
//        } catch (IOException e) {
//            e.printStackTrace();
