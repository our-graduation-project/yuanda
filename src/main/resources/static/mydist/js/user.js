$(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '头像', name: 'createTime', index: 'createTime', sortable: false, width: 80},
            {label:  '性别', name: 'userToken',index: 'userToken',sortable: false, width: 80},
            {label:  '邮箱', name: 'userToken',index: 'userToken',sortable: false, width: 80},
            {label:  '简介', name: 'userToken',index: 'userToken',sortable: false, width: 80}
        ],
        //表格高度，可自行调节
        height: 485,
        //默认一页显示多少条数据，可自行调节
