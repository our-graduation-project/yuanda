$(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '图片', name: 'createTime', index: 'createTime', sortable: false, width: 80},
            {label:  '内容', name: 'userToken',index: 'userToken',sortable: false, width: 80},
            ...
            {label:  '推荐度', name: 'userToken',index: 'userToken',sortable: false, width: 80}
