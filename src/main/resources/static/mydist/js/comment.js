$(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '评论内容', name: 'createTime', index: 'createTime', sortable: false, width: 80},
            {label:  '评论对象', name: 'userToken',index: 'userToken',sortable: false, width: 80},
            {label:  '审核是否通过', name: 'userToken',index: 'userToken',sortable: false, width: 80}
        ],
        //表格高度，可自行调节
        height: 485,
        //默认一页显示多少条数据，可自行调节
